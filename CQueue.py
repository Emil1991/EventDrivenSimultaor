...
class CQueue(object):
    ...
    def __init__(self, max_people_in_queue:int, probabilities_to_stay:dict ):
        ...
        self.probabilities_to_stay_per_amount_of_people = {};
    ...
    def addResidentToTheQueue(self, resident:CResident)->bool:
        ...
        if( random.random_integers(1,10,10) >= range ):
            return False;
    ...
    def removeResidentFromTheQueue(self):
        ...
        self.wait_time_list.append(resident.waiting_time);
        self.service_time_list.append(resident.service_time);
